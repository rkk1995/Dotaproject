...
def GetProPlayersFromMatch(players,game):
    allplayers = []
    gameinfo = {}
...
for i in livematches:
    total = GetProPlayersFromMatch(i['players'],i)
    if total:
        currentgames.append(total)
print(len(currentgames))

#creating data to feed into template. Needs to be in form List of Dictionaries with relevant data

#https://api.steampowered.com/IDOTA2MatchStats_570/GetRealtimeStats/v1/?key=BDAECC2049E139D32D5D7AEDEFC23304&partner=0&server_steam_id=90127556102489090
